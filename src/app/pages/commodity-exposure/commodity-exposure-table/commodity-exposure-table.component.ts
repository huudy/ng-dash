...
@Component({
  selector: 'app-commodity-exposure-table',
  templateUrl: './commodity-exposure-table.component.html',
  styleUrls: ['./commodity-exposure-table.component.scss']
})
export class CommodityExposureTableComponent implements OnInit, OnChanges {
    ...
    this.table = this.DatatablesService.createDatatable(
      '#commodityExposureTable',
      {
        ...
        columns: [
          ...
          { data: "outstandingNotional", className: "right-align", render: function (data, type, row) { return self.DatatablesService.formatAmount(row, 'outstandingNotional', 'totalNotionalCurrency') } },
      ...
      self.drawGraph,
      self.DatatablesService.configureExport([0, 1, 6, 7, 2, 3, 4])
    );
