...
@Component({
  selector: 'app-transaction-exposure-table',
  templateUrl: './transaction-exposure-table.component.html',
  styleUrls: ['./transaction-exposure-table.component.scss']
})
export class TransactionExposureTableComponent implements OnInit, OnChanges {
  ...
  buildtable() {
    ...
    this.table = this.DatatablesService.createDatatable(
      ...
      self.drawGraph,
      self.DatatablesService.configureExport([0, 1, 7, 8, 2, 3, 4])
    );
